            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">                        
                        {!! Form::model($item, ['route' => ['update-item', $item->item_id], 'method' => 'put', 'files' => true, 'class' => 'form']) !!}
                        	<div class="row">                        	
                        		...
                        		<div class="form-group{{ $errors->has('subarea_id') ? ' has-error' : '' }} col-xs-12 col-sm-6 col-md-6">
                                    ...
                                    {!! Form::select('subarea_id', $subareas, null, ['class' => 'form-control', 'placeholder' => 'Seleccione subarea', 'required' => 'required']) !!}
                            ...
                            <div class="form-group{{ $errors->has('filename') ? ' has-error' : '' }}">
                                {!! Form::label('filename', 'Archivo PDF') !!} (<a href="{{ route('item-file', $item->item_id) }}" target="_blank">{{ $item->filename }}</a>)
